...
| What records what a review saw? | [ADR-031](../architecture/adrs/031-codex-review-stopping-model.md) - a publication names the candidate tree it read; review remains observational and does not authorize delivery |
