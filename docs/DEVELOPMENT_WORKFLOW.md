...
assumed; the commit then also fires any installed hook, which is Git's behavior
and not a second workflow step. The agent also leaves committing to `publish`,
