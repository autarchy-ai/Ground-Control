...
* add grndctl init and doctor for per-repository setup ([7b82706](https://github.com/autarchy-ai/Ground-Control/commit/7b827062f5ea4d62cff6144857982bee31decd91))
* add repository-scoped sandbox variables ([6680477](https://github.com/autarchy-ai/Ground-Control/commit/668047797e2e7feda64a34e8c7c818f7a52774c4))
* add repository-scoped sandbox variables ([efe33f0](https://github.com/autarchy-ai/Ground-Control/commit/efe33f0168968d6bbde5a5ee4bace2b90ed37348))
* automate mechanical implement phases ([56d1f7e](https://github.com/autarchy-ai/Ground-Control/commit/56d1f7ea898dfe44b9dee241160dd76c80070f1b))
* automate mechanical implement phases ([dbb2d3f](https://github.com/autarchy-ai/Ground-Control/commit/dbb2d3f11d59609173b0a1acacde5bb3accc465b))
* **console:** add SaaS-grade shell, design system, and session read (GC-Q015) ([9ac670d](https://github.com/autarchy-ai/Ground-Control/commit/9ac670d3acc96f0307c54d5713f5da3447e4b0fb))
* **console:** SaaS-grade shell, design system, and session read (GC-Q015) ([d74517c](https://github.com/autarchy-ai/Ground-Control/commit/d74517c77bf2d1b60eda5f1be50be9d346548803))
* **console:** SaaS-grade shell, design system, and session read (GC-Q015) ([c34d675](https://github.com/autarchy-ai/Ground-Control/commit/c34d675a1761feebcdef8991dac5f2d44072c5a5))
* **contracts:** publish the measurement contract and station catalogue ([f75be0c](https://github.com/autarchy-ai/Ground-Control/commit/f75be0c877ce99da3193bbc0a2042db23b19101a))
* **contracts:** publish the measurement contract and station catalogue ([ce900f6](https://github.com/autarchy-ai/Ground-Control/commit/ce900f6a3d57d00a12622361e714c1de8111e465))
* define native agent dashboard connection ([3cac89f](https://github.com/autarchy-ai/Ground-Control/commit/3cac89fe468ef9010e4289855fdf4fb1fd9aa49b))
* **dispatch:** admit verification commands against a host-wide CPU budget ([73147b9](https://github.com/autarchy-ai/Ground-Control/commit/73147b907f7a99f9eaeb45b46956ea396506ebc6))
* **dispatch:** admit verification commands against a host-wide CPU budget ([0592229](https://github.com/autarchy-ai/Ground-Control/commit/0592229a756663acb0f97eba5cea23488f9c965a))
* **identity:** add audited identity foundation ([1b29ae9](https://github.com/autarchy-ai/Ground-Control/commit/1b29ae99db408f05a766493bfa85b4d3617d41b9))
* **identity:** add audited identity foundation ([ff896fd](https://github.com/autarchy-ai/Ground-Control/commit/ff896fd1f41e6a8a45c2266c656a96733681854b))
* **implement:** finish phase e from the merge event without an agent ([b2076ee](https://github.com/autarchy-ai/Ground-Control/commit/b2076ee5c47769228dfcd471eaedbdfdbd504257))
* **implement:** finish Phase E from the merge event without an agent ([e8ad85e](https://github.com/autarchy-ai/Ground-Control/commit/e8ad85ecdf8ca700b2901256ce21df81d06501b8))
* **implement:** tier publish verification with a content-addressed attestation ([efcdab9](https://github.com/autarchy-ai/Ground-Control/commit/efcdab9fdd32199f8fcc5b67281b970bdcfa2fb0))
* **implement:** tier publish verification with a content-addressed attestation ([4451992](https://github.com/autarchy-ai/Ground-Control/commit/44519929a4e3534db65c02e39b97ab4b913651ee))
* **mcp:** add a tool that writes an issue's requirements section ([741b8b6](https://github.com/autarchy-ai/Ground-Control/commit/741b8b65d9c28475d406f282835511034a55503a))
* **mcp:** add gc_issue_dependency for GitHub issue blockers ([82742b7](https://github.com/autarchy-ai/Ground-Control/commit/82742b776fd2e369647597be7d31b010da6077dd))
* **mcp:** add gc_issue_dependency for GitHub issue blockers ([96949d7](https://github.com/autarchy-ai/Ground-Control/commit/96949d7981133973e9081935077fee02d692adab))
* **measurement:** validate emitted station facts against the published catalogue ([a85b6c7](https://github.com/autarchy-ai/Ground-Control/commit/a85b6c777d8d4d48c539bef54b25ccc38bf7c4cc))
* migrate coding sessions into sandbox VMs ([6c669a3](https://github.com/autarchy-ai/Ground-Control/commit/6c669a34130a2ac631846e2ef47048eb09cb4cc5))
* publish Ground Control to npm as grndctl ([e18e955](https://github.com/autarchy-ai/Ground-Control/commit/e18e9550d8968dea35c3cbff747bdabeb08d2f59))
* publish Ground Control to npm as grndctl ([3a8ebf2](https://github.com/autarchy-ai/Ground-Control/commit/3a8ebf2f3308ad491d3814a4f9b80472744f71f2))
* **requirements:** export requirements to specs-as-code with frontmatter lint ([200cde8](https://github.com/autarchy-ai/Ground-Control/commit/200cde849ac0ca7d97f894c793caaa91e406f769))
* **requirements:** export requirements to specs-as-code with frontmatter lint ([5f8c5da](https://github.com/autarchy-ai/Ground-Control/commit/5f8c5da7aa5a1facdd22f895479734edac1b4fbb))
* reserve release identities for concurrent workflows ([8731678](https://github.com/autarchy-ai/Ground-Control/commit/873167883e5f4fca4525e8295f27d7c49d60dbc1))
* **review:** add maintainer pull request review lane ([59eb6f1](https://github.com/autarchy-ai/Ground-Control/commit/59eb6f152ea86c3685ae2cfc4a1f3aac27f02e5c))
* **review:** add maintainer pull request review lane ([da71232](https://github.com/autarchy-ai/Ground-Control/commit/da71232bcc2045c244db85b96e13d5f5d58cc1b8))
* **review:** load a user-owned auth fallback when the launcher provides none ([d859430](https://github.com/autarchy-ai/Ground-Control/commit/d8594303014f185a5177a298aa214ff823e1d385))
* **review:** separate local review execution from publication ([84d335c](https://github.com/autarchy-ai/Ground-Control/commit/84d335c7952b2e2a7851ca7549b72937921e339b))
* **sandbox:** add isolated incus coding vms ([66100a2](https://github.com/autarchy-ai/Ground-Control/commit/66100a2afeaa1aad10473a2d451b56708400e656))
* **sandbox:** add isolated incus coding vms ([e9d9413](https://github.com/autarchy-ai/Ground-Control/commit/e9d9413263596d313a2f2fca155840d4016a4495))
* **sandbox:** build and ship the guest template with the package ([201afbb](https://github.com/autarchy-ai/Ground-Control/commit/201afbbb0e267a3ef1465ce400e281adff5c36f3)), closes [#1680](https://github.com/autarchy-ai/Ground-Control/issues/1680)
* **sandbox:** distribute the guest template through the container registry ([5ab4acb](https://github.com/autarchy-ai/Ground-Control/commit/5ab4acb36fdd8a055c5548951c20c760d305ec92))
* **sandbox:** distribute the guest template through the container registry ([d842726](https://github.com/autarchy-ai/Ground-Control/commit/d84272605a5987e01aebdd37d0a541f9bccf5a84))
* **sandbox:** prepare private repository guests ([10f969a](https://github.com/autarchy-ai/Ground-Control/commit/10f969a5e5474719de0ea285ec3f7baffd21a236))
* **sandbox:** prepare private repository guests ([bea6038](https://github.com/autarchy-ai/Ground-Control/commit/bea603821bcceee320a98e70af7bd2788d412bc5))
* separate review execution from publication ([d1f4881](https://github.com/autarchy-ai/Ground-Control/commit/d1f488109ac55ed5131d7562fd184c5f14ca9136))
* synchronize implement branches before PRs ([2680278](https://github.com/autarchy-ai/Ground-Control/commit/2680278d0459e817208d5e226826a349c1e52e9e))
* **telemetry:** add production-line measurement model ADR and emitter sync gate ([e422a12](https://github.com/autarchy-ai/Ground-Control/commit/e422a125e066b61bff6299cc6df8d23c7551d0d9))
* **telemetry:** add production-line measurement model ADR and emitter sync gate ([fd7f37f](https://github.com/autarchy-ai/Ground-Control/commit/fd7f37f70db84e580aed220c1df02eadc30f84de))
* **telemetry:** durable ADR-036 step-observation sink ([09d474c](https://github.com/autarchy-ai/Ground-Control/commit/09d474c22bebc4abee46ce8a083c8029123e886c))
* **telemetry:** durable ADR-036 step-observation sink ([624d318](https://github.com/autarchy-ai/Ground-Control/commit/624d3181d32ca68679cfe083dbc95c8fa612c73b))
* **telemetry:** durable ADR-036 step-observation sink ([b20e0fe](https://github.com/autarchy-ai/Ground-Control/commit/b20e0fed8cb330793bd9b3c2e563365b9c88f780))
* **telemetry:** emit gate outcomes and review findings as measurement events ([1ac84db](https://github.com/autarchy-ai/Ground-Control/commit/1ac84db2f183ef45b3f3097b5368a554a5e7fdea))
* **telemetry:** emit gate outcomes and review findings as measurement events ([1a70d9f](https://github.com/autarchy-ai/Ground-Control/commit/1a70d9f9dd564ccdff5a9094461d4ec34b6326fe)), closes [#1355](https://github.com/autarchy-ai/Ground-Control/issues/1355)
* **telemetry:** emit workflow-run lifecycle live from the implement tool layer ([2e67901](https://github.com/autarchy-ai/Ground-Control/commit/2e6790107514083531c9a80a048adac18d9cc9e1))
* **telemetry:** emit workflow-run lifecycle live from the implement tool layer ([9a0bd68](https://github.com/autarchy-ai/Ground-Control/commit/9a0bd68f9fee20104ccf8d919a1c49341d532761))
* **telemetry:** stream workflow-run and phase events to the console live ([393ea4b](https://github.com/autarchy-ai/Ground-Control/commit/393ea4bcead22dfb60f699563a6e31adfe128e20))
* **telemetry:** stream workflow-run and phase events to the console live ([f111140](https://github.com/autarchy-ai/Ground-Control/commit/f1111409f02b207acd213b5fbdf497b0f3d76f89))
* **workflow:** add live activity workspace ([423e085](https://github.com/autarchy-ai/Ground-Control/commit/423e085648c03038b1897f19b0de81b3c4e0eb41))


### Bug Fixes

* address Sonar findings in CI verification changes ([c0858bd](https://github.com/autarchy-ai/Ground-Control/commit/c0858bdabc1dd145571249e681f0e8eb93cd5d06))
* align watcher fixtures and retire completion stage metadata ([1e52e38](https://github.com/autarchy-ai/Ground-Control/commit/1e52e3893c679f04a24d1b5168a27aa710b735d2))
* bind the CI watcher to the pushed head commit ([f841058](https://github.com/autarchy-ai/Ground-Control/commit/f84105882c9a218342e812aaeac2de518a97805c))
* bind the CI watcher to the pushed head commit ([b7aa962](https://github.com/autarchy-ai/Ground-Control/commit/b7aa9622ac05c509b40ced15eabc2ac4e70b451b))
* canonicalize GitHub traceability identifiers ([3672c09](https://github.com/autarchy-ai/Ground-Control/commit/3672c09ba2535112a4867c9ee113949e317b7c0f))
* **ci:** add V212 to schema-version list and assert non-empty export walk ([56be03e](https://github.com/autarchy-ai/Ground-Control/commit/56be03e27e9d199a8cb202b2acafad17c89a57cb))
* **ci:** reconcile live branch protection with the versioned baseline ([73d4784](https://github.com/autarchy-ai/Ground-Control/commit/73d47847cd0894f185f9e1e3096dc5f6b6591271))
* **ci:** reconcile live branch protection with the versioned baseline ([d7ca16f](https://github.com/autarchy-ai/Ground-Control/commit/d7ca16f6b2e45f45db474c3f03bb36c4ff693058))
* **ci:** resolve sonar assertion findings in exporter tests ([d84d99b](https://github.com/autarchy-ai/Ground-Control/commit/d84d99b55d1d77835b2c25f93ede2ed0357df8a9))
* **ci:** satisfy the strict Sonar python profile on the new gate ([80f7d0e](https://github.com/autarchy-ai/Ground-Control/commit/80f7d0e1dc9324326c0443a2c56d18d64537191f))
* clear the code smells sonar reports in the split test files ([c9eb804](https://github.com/autarchy-ai/Ground-Control/commit/c9eb804849f31d3f708608dc7a8869c127756f11))
* clear the sonar findings raised by the service decomposition ([3c05e95](https://github.com/autarchy-ai/Ground-Control/commit/3c05e9529f9fb6a04321692c4fa9ca2230161102))
* close requirement-free issues after merge on a non-default base ([1209ffe](https://github.com/autarchy-ai/Ground-Control/commit/1209ffe70828e67163fbaf508118e3a2bdab920a))
* **contracts:** regenerate openapi.json in the canonical sorted form ([17891d6](https://github.com/autarchy-ai/Ground-Control/commit/17891d68638d376c991b6cb5681c1a569661cd6e))
* **contracts:** regenerate the OpenAPI surface for the measurement endpoints ([0086d33](https://github.com/autarchy-ai/Ground-Control/commit/0086d3380916b8abd88aa0a4ce1bcf289dd91b23)), closes [#1355](https://github.com/autarchy-ai/Ground-Control/issues/1355)
* **contracts:** type the whole generated client precisely instead of any ([f38451f](https://github.com/autarchy-ai/Ground-Control/commit/f38451fa36d9b56b02753698627285c84a12a994))
* **contracts:** type the whole generated client precisely instead of any ([04489bc](https://github.com/autarchy-ai/Ground-Control/commit/04489bcbc76cf36018d70123d9c867ff1606c34d))
* deduplicate implementation verification ([c7e0478](https://github.com/autarchy-ai/Ground-Control/commit/c7e0478e7a3d2724f00841346dbbf31c1b8ca038))
* deduplicate implementation verification ([e93d89f](https://github.com/autarchy-ai/Ground-Control/commit/e93d89f981bb46805515323c865f25acd141b94f))
* **deps:** clear osv-scanner findings via dependency upgrades and ignore the no-fix nltk advisory ([1181dab](https://github.com/autarchy-ai/Ground-Control/commit/1181dab3b53de7d204aadf6ea81f0785273c8693))
* **deps:** raise gradio and orjson security floors to the locked releases ([e419734](https://github.com/autarchy-ai/Ground-Control/commit/e419734761d80281dbef3629a7a5b28fa68530cd))
* **deps:** raise Spring Framework and Spring Data to patched CVE releases ([984e95c](https://github.com/autarchy-ai/Ground-Control/commit/984e95cd863a1deda5ea2b171a333e6ba7af3be7))
* **deps:** resolve the nltk advisory record and clear new osv findings ([2e15dde](https://github.com/autarchy-ai/Ground-Control/commit/2e15ddef62922bbb6742ac719197256025fc055b))
* **deps:** resolve the nltk advisory record and clear new osv findings ([eafec76](https://github.com/autarchy-ai/Ground-Control/commit/eafec76fece942c45c3de4e06f388ee0bd59a52b))
* derive implement policy and pre-commit gates from repository configuration ([e6b19b5](https://github.com/autarchy-ai/Ground-Control/commit/e6b19b5f44e3e28b69173257f4e744c03b067c89))
* derive the implement policy gate from repository configuration ([0fe116a](https://github.com/autarchy-ai/Ground-Control/commit/0fe116ac2ac0217c72b888908b13464f05cbd260))
* derive the implement pre-commit boundary from repository configuration ([a98355b](https://github.com/autarchy-ai/Ground-Control/commit/a98355be1df33b7662be6215d49bdd643999ed28))
* **dispatch:** satisfy the strict python profile and keep state off shared dirs ([c3e2452](https://github.com/autarchy-ai/Ground-Control/commit/c3e2452fc555f26a32f1c76dad622c1f67ef0393))
* **dispatch:** tighten dispatcher type hints and drop dead test helpers ([3e5ac83](https://github.com/autarchy-ai/Ground-Control/commit/3e5ac837ec26fd191021ed1680eaf4d7e4692815))
* **docs:** lock the docs toolchain with hashes above the idna advisory fix ([db661a8](https://github.com/autarchy-ai/Ground-Control/commit/db661a8e715ea151c380853f86f0092439702bcd))
* drop unreferenced fixtures from split classes and restore the generated spec ([279fba3](https://github.com/autarchy-ai/Ground-Control/commit/279fba3bea235dfb94e3580fcbfcf8eb99d9e330))
* drop unused nested members and restore the committed contract artifacts ([845bf77](https://github.com/autarchy-ai/Ground-Control/commit/845bf77d8d61b6d1adeb96c5cb60547b56efdd15))
* exclude test shims from server environment inventory ([bd203fb](https://github.com/autarchy-ai/Ground-Control/commit/bd203fb11b1317c6c6fb9f2c0b934e286a261d5d))
* give each deprecated overload its own javadoc tag ([65b34f8](https://github.com/autarchy-ai/Ground-Control/commit/65b34f8de5794d8dbbb86cc3806a3a8644299f7c))
* give the extracted not-found test class its mockmvc autoconfiguration ([7a5b662](https://github.com/autarchy-ai/Ground-Control/commit/7a5b662a47b016abcde38f16c9ad121edecc2879))
* **implement:** bound and recover the mechanical publish base merge ([5d152bd](https://github.com/autarchy-ai/Ground-Control/commit/5d152bded9fe298585d47fa8001a0b550f0c71d1))
* **implement:** bound and recover the mechanical publish base merge ([ca2aa7a](https://github.com/autarchy-ai/Ground-Control/commit/ca2aa7ab506a1140976c3196e6fffa05f70b45f0))
* **implement:** clear sonarcloud findings and enforce the sonar gate for GC ([561ddb0](https://github.com/autarchy-ai/Ground-Control/commit/561ddb04b2bafcda31d38ea3d1d7328d072d383a))
* **implement:** clear sonarcloud reliability findings in touched modules ([5dbe024](https://github.com/autarchy-ai/Ground-Control/commit/5dbe0243e16910006447482b6083c48747d17128))
* **implement:** harden branch resolution + doc-lint gates, remove telemetry summarizer ([#1507](https://github.com/autarchy-ai/Ground-Control/issues/1507)) ([28ff0e7](https://github.com/autarchy-ai/Ground-Control/commit/28ff0e7cf2c134500298f1ae8bb5d74ba9076c0a))
* **implement:** make gc_render_pr_body PR-body envelope repo-neutral ([#1199](https://github.com/autarchy-ai/Ground-Control/issues/1199)) ([c05c590](https://github.com/autarchy-ai/Ground-Control/commit/c05c590f17a42b1ec015b443792d4af32121a603))
* **implement:** make gc_render_pr_body PR-body envelope repo-neutral ([#1199](https://github.com/autarchy-ai/Ground-Control/issues/1199)) ([6d9a5af](https://github.com/autarchy-ai/Ground-Control/commit/6d9a5afc250a0af8c5b22e8d64f8bf9ccc58fdb1))
* **implement:** make publish/monitor branch_name optional and lint uncommitted docs ([#1507](https://github.com/autarchy-ai/Ground-Control/issues/1507)) ([4d9884b](https://github.com/autarchy-ai/Ground-Control/commit/4d9884bd820ff4450807b87eeaafe546c5cde7ad))
* **implement:** pin identity guard to shared common git dir ([d4bef26](https://github.com/autarchy-ai/Ground-Control/commit/d4bef26bd050de3ec24c812986fddb2ff4a1673b))
* **implement:** pin identity guard to shared common Git dir ([014b6bf](https://github.com/autarchy-ai/Ground-Control/commit/014b6bfe81036f796ffd56d30737ba8e462c780f))
* **implement:** point workflow skills at the file-based requirement flow ([#1500](https://github.com/autarchy-ai/Ground-Control/issues/1500)) ([9c1f959](https://github.com/autarchy-ai/Ground-Control/commit/9c1f9594e05cec87dd1636647ebcba5ff29ba15f))
* **implement:** point workflow skills at the file-based requirement flow ([#1500](https://github.com/autarchy-ai/Ground-Control/issues/1500)) ([5165496](https://github.com/autarchy-ai/Ground-Control/commit/516549611b2779ffb15d6a22bacb5419ef80cfb6))
* **implement:** run repository gates through a size-safe command runner ([ef69bc3](https://github.com/autarchy-ai/Ground-Control/commit/ef69bc369771945012da852433953f15c3cccdc0))
* **implement:** run repository gates through a size-safe command runner ([3fc0e7c](https://github.com/autarchy-ai/Ground-Control/commit/3fc0e7c63d157e5e5462bccde5bf0a864c2d0044))
* **implement:** satisfy sonarcloud reliability rules in the verification attestation ([4eafeec](https://github.com/autarchy-ai/Ground-Control/commit/4eafeece2570d5f864d8c516fa230f0abc96377b))
* **implement:** scope the size-safe gate runner to the completion boundary ([166c239](https://github.com/autarchy-ai/Ground-Control/commit/166c239e5a45346cc4cade136a20d3701753a53f))
* **implement:** stop no-change Phase E resume from running the verifier ([b49ef4a](https://github.com/autarchy-ai/Ground-Control/commit/b49ef4abd5da6d575656502b4462d99a13e93cf7))
* **implement:** stop no-change Phase E resume from running the verifier ([d355556](https://github.com/autarchy-ai/Ground-Control/commit/d35555629036af313cbde51c6bf657d5a1b11d86)), closes [#1543](https://github.com/autarchy-ai/Ground-Control/issues/1543)
* **implement:** verify merged requirement state before completion ([0c127ae](https://github.com/autarchy-ai/Ground-Control/commit/0c127aef17f998f7e325ff4b1301238a18781dbb))
* **implement:** verify merged requirement state before completion ([fc11cff](https://github.com/autarchy-ai/Ground-Control/commit/fc11cff6352e298a2e2f22f07d5d969e9712359b))
* **implement:** wrap phase-e-noop check message under the line-length limit ([68eb9f8](https://github.com/autarchy-ai/Ground-Control/commit/68eb9f80f3c958e7b26c6683448f3aee0a396551))
* inject mocks, narrow thrown-by lambdas and drop unread callback fields ([8a97595](https://github.com/autarchy-ai/Ground-Control/commit/8a97595581ef2749a7844788a77bb8a8217b53c7))
* keep ordered test classes whole, prune split fixtures, fix vale dashes ([d76c0d6](https://github.com/autarchy-ai/Ground-Control/commit/d76c0d6d75abc8fce12b117650d57bebdf132d29))
* let the quickfix lane open a pull request without a published review ([cbd2658](https://github.com/autarchy-ai/Ground-Control/commit/cbd2658eb6fbe9516ff42703a13293e2570ea9e7))
* make review records observational ([8f150a9](https://github.com/autarchy-ai/Ground-Control/commit/8f150a93bf95bbca12b1958bc440a047600d5da8))
* **mcp:** accept breaking-change marker in synchronized pr titles ([782a3e9](https://github.com/autarchy-ai/Ground-Control/commit/782a3e98cd5aed64972d111abcc50a950deb51d9))
* **mcp:** accept short requirement uids across workflow tools ([13d882a](https://github.com/autarchy-ai/Ground-Control/commit/13d882a9f2cd107ad587d6fd1cdd4704ef6c3a02))
* **mcp:** add a bounded terminal wait to the async job transport ([9fc9a67](https://github.com/autarchy-ai/Ground-Control/commit/9fc9a67a167d7a700c2d9b5e9f1b33b0f7934c48))
* **mcp:** add a bounded terminal wait to the async job transport ([a9daa02](https://github.com/autarchy-ai/Ground-Control/commit/a9daa02a60f652b5a20ab26dac02e3c91105f679))
* **mcp:** auto-resolve the sole in-scope requirement UID for repository gates ([7f6c600](https://github.com/autarchy-ai/Ground-Control/commit/7f6c6008eaec328fdb7bdabf9a687c000218d0c9))
* **mcp:** auto-resolve the sole in-scope requirement UID for repository gates ([3bb8741](https://github.com/autarchy-ai/Ground-Control/commit/3bb87419df5bdf541f9b722f2e4b65db208c1ef2))
* **mcp:** bind every integrate action to the launch workspace ([fdcbeb3](https://github.com/autarchy-ai/Ground-Control/commit/fdcbeb389f4b01874e942d7526ffb158c357d83c))
* **mcp:** bind every integrate action to the launch workspace ([2b9fdee](https://github.com/autarchy-ai/Ground-Control/commit/2b9fdee9e57f57221800a1598c77895c4259880e))
* **mcp:** bind integrate status and release to the launch workspace ([f7ed735](https://github.com/autarchy-ai/Ground-Control/commit/f7ed73535153999a157c4ee9d5ebedab07065a9d))
* **mcp:** bound integrate filesystem sinks and split oversized functions ([124e489](https://github.com/autarchy-ai/Ground-Control/commit/124e48913dd0232ca033c99371a75a3f8d096639))
* **mcp:** bound the model-engine subprocess tree, not just the direct child ([ac588c8](https://github.com/autarchy-ai/Ground-Control/commit/ac588c8f18a485c4b294619182fe74ce6a80f8f6))
* **mcp:** bound the whole model-engine subprocess tree, not just the direct child (issue [#1518](https://github.com/autarchy-ai/Ground-Control/issues/1518)) ([81a0d3a](https://github.com/autarchy-ai/Ground-Control/commit/81a0d3a1036eff4a8d28f717ec0257dfcdd8c1ce))
* **mcp:** bump js-yaml to 4.3.1 to patch GHSA-5p4m-2wfm-xmqj (CI security scan) ([a4eee0e](https://github.com/autarchy-ai/Ground-Control/commit/a4eee0e6e7018be4f6aab87eccc46aaff7b59f0d))
* **mcp:** carry requirement identity into repository gates ([abe106d](https://github.com/autarchy-ai/Ground-Control/commit/abe106d8f834faf140a9c612da42c2ae1b7abe4b))
* **mcp:** carry requirement identity into repository gates ([fa74ee0](https://github.com/autarchy-ai/Ground-Control/commit/fa74ee0ffc775e34d15c54a346df946d63ed97b3))
* **mcp:** correct server version, review attestation, and stale docs ([c38fefc](https://github.com/autarchy-ai/Ground-Control/commit/c38fefc9146e25cd5850e63d21a29be9ef77351b))
* **mcp:** fix mcp env loading ([cb9a2f6](https://github.com/autarchy-ai/Ground-Control/commit/cb9a2f6795e1c4d7ec8b6d7bc642af994c0cdf9b))
* **mcp:** infer project from repo config in completion assertion ([be846b0](https://github.com/autarchy-ai/Ground-Control/commit/be846b0806b831123fc6e8d69dcdcc8a7cbd6017))
* **mcp:** infer project from repo config in completion assertion ([27c6453](https://github.com/autarchy-ai/Ground-Control/commit/27c6453a2934ba6ec5c71a2790796d72724cafb3))
* **mcp:** make long-running mechanical actions asynchronous ([60e3b0f](https://github.com/autarchy-ai/Ground-Control/commit/60e3b0fb2a5f27988d8e92bdc5c83e9a176fc7a3))
* **mcp:** make pr body review attestation lane-aware ([bb6bd4a](https://github.com/autarchy-ai/Ground-Control/commit/bb6bd4a2aa71c6d6504f59c34853b9f24835ce19))
* **mcp:** make review cycles idempotent and asynchronous ([ce19958](https://github.com/autarchy-ai/Ground-Control/commit/ce199588c156bca3fdf8aff88b5691b1f5fa6357))
* **mcp:** move GitHub reads and writes off GraphQL to REST ([ee0277a](https://github.com/autarchy-ai/Ground-Control/commit/ee0277a3b96dddfff7d580fc5fca696e5a78b690))
* **mcp:** move GitHub reads and writes off GraphQL to REST ([6a79492](https://github.com/autarchy-ai/Ground-Control/commit/6a79492d7288b06a203c40d935aef69aa5f3fe9d))
* **mcp:** move the maintainer review lane off GraphQL to REST ([f933941](https://github.com/autarchy-ai/Ground-Control/commit/f933941d9c00b0b1645ef860ddc0b93964765aca))
* **mcp:** move the maintainer review lane off GraphQL to REST ([51345ee](https://github.com/autarchy-ai/Ground-Control/commit/51345ee4af9841810a328f1dedbbcf71ca228eae))
* **mcp:** pin issue-thread record tools to the MCP launch workspace ([8fa8857](https://github.com/autarchy-ai/Ground-Control/commit/8fa8857bb39fe95ca28e58537c45ff07ec9cfc06))
* **mcp:** read ground control variables only from the launch directory .env ([53f4916](https://github.com/autarchy-ai/Ground-Control/commit/53f4916fc860e9b8bd2e98c35fada29ab109d872))
* **mcp:** read ground control variables only from the launch directory .env ([57e1916](https://github.com/autarchy-ai/Ground-Control/commit/57e19165ba2bd748b5ce209f94ecc858a8ba52cc))
* **mcp:** recover stranded station-observation obligations from trusted verdict records ([1824583](https://github.com/autarchy-ai/Ground-Control/commit/182458340aa8742d4d28b57f4fa0c7d8c7ef8717))
* **mcp:** remove dead GRC/backend tool handlers left over from the [#1500](https://github.com/autarchy-ai/Ground-Control/issues/1500) purge ([b8bf417](https://github.com/autarchy-ai/Ground-Control/commit/b8bf4175c7b525eebb466092169cc5cc3615adfc))
* **mcp:** remove dead GRC/backend tool handlers left over from the [#1500](https://github.com/autarchy-ai/Ground-Control/issues/1500) purge ([8a067a7](https://github.com/autarchy-ai/Ground-Control/commit/8a067a71ffb692e3007d706e6f4c4b4e5dd613b7))
* **mcp:** resolve GC_CODEX_TIMEOUT_MS lazily instead of at module-import time ([65fba4f](https://github.com/autarchy-ai/Ground-Control/commit/65fba4f715eab822065695b07207e0476355c921))
* **mcp:** resolve SonarCloud findings in the REST conversion ([d7cd219](https://github.com/autarchy-ai/Ground-Control/commit/d7cd2192905850ed9930698e5e7f5116a325cb1b))
* **mcp:** resolve SonarCloud maintainability findings on shifted lines ([5138f24](https://github.com/autarchy-ai/Ground-Control/commit/5138f24ce2ed8c59b3089f9090bf274f22719106))
* **mcp:** resolve the model-subprocess timeout env var lazily, not at import time ([63ec2d6](https://github.com/autarchy-ai/Ground-Control/commit/63ec2d62ef530a0a0ae826a35a2b04648a019622))
* **mcp:** restore the integrate lane tool removed as dead code ([f1887a9](https://github.com/autarchy-ai/Ground-Control/commit/f1887a9df27b1f3ffe73f9199388bc3314a7ae0c))
* **mcp:** restore the integrate lane tool removed as dead code ([0a4584b](https://github.com/autarchy-ai/Ground-Control/commit/0a4584b4a575d672f9c123fbacfd1dce00545fc7))
* **mcp:** run mechanical actions as background jobs ([e50be1d](https://github.com/autarchy-ai/Ground-Control/commit/e50be1d9648842b527aac00cbbdc6ada07749dcc))
* **mcp:** skip settings prompts in grndctl init when a config already exists ([c683e65](https://github.com/autarchy-ai/Ground-Control/commit/c683e65a09ba495f657052e21283ba07c4bf7f15))
* **mcp:** source server version from package.json ([bd84af7](https://github.com/autarchy-ai/Ground-Control/commit/bd84af799e7221f1e7f9d04df95dae7e5fdd53c8))
* **mcp:** validate integrate path sinks inline and split remaining functions ([5fc7cff](https://github.com/autarchy-ai/Ground-Control/commit/5fc7cff3323134184a9cfd7b06648d2d37640edf))
* **mcp:** wait for stdout/stderr end, not just process close, in execFileWithInput ([33a1e5e](https://github.com/autarchy-ai/Ground-Control/commit/33a1e5ee4c89f218dabb91a72d47e8c85672b81e))
* **mcp:** watch every run for the head commit in the CI gate ([0fb3573](https://github.com/autarchy-ai/Ground-Control/commit/0fb3573d9389a3ac30696c52bfdb1ec6a8c7f03e))
* **measurement:** carry the truncated-batch count through the contract ([2dd035e](https://github.com/autarchy-ai/Ground-Control/commit/2dd035e9f3457584a43f03c2a513d5a6b9444676))
* **measurement:** clear the SonarCloud new-issue gate on the catalogue validator ([b4148ac](https://github.com/autarchy-ai/Ground-Control/commit/b4148ac38db7408f2122cabaa3d91f4dd3cbb81a))
* **measurement:** require recorded authority to retire a gate finding unfixed ([9f08167](https://github.com/autarchy-ai/Ground-Control/commit/9f0816748766a80e661f56650a186b73284926b6))
* **measurement:** stop counting infrastructure outcomes and stale artifacts as gate verdicts ([4486efc](https://github.com/autarchy-ai/Ground-Control/commit/4486efcd7b1bfcf1deda40cc7f4bbd7bcd0a1034))
* **monitor:** start a fresh child watch after a non-verdict rerun ([d33026e](https://github.com/autarchy-ai/Ground-Control/commit/d33026e2476fba5d884bbc9ebce486be09469e4c))
* **monitor:** start a fresh child watch after a non-verdict rerun ([174683b](https://github.com/autarchy-ai/Ground-Control/commit/174683bd756a37240644c144cb15ac242aae7334))
* narrow the remaining catchThrowableOfType lambdas to one throwing call ([bf15887](https://github.com/autarchy-ai/Ground-Control/commit/bf15887d2e57f665fe5b5d0bfdf3fe9ee2f00eb7))
* override upstream hook stages to prevent push duplication ([01da417](https://github.com/autarchy-ai/Ground-Control/commit/01da417476a393dc47cb1d00888a43bdbb97d2f2))
* **phase-e:** bind a dispatch finalizer run to the pr it finalizes ([0445e5b](https://github.com/autarchy-ai/Ground-Control/commit/0445e5be725e9669d5e44a0dd49ff0b633b17be6))
* **phase-e:** bind a finalizer run to its merged pull request ([a88ac5b](https://github.com/autarchy-ai/Ground-Control/commit/a88ac5bd833e221f6d770c36e689ccb5b89223f2))
* **phase-e:** bind a finalizer run to its merged pull request ([f497cbf](https://github.com/autarchy-ai/Ground-Control/commit/f497cbf54f9b7e6b9738459f69e0ba6c5056bbf3))
* **phase-e:** drop the pickup label when the issue actually closes ([62294ec](https://github.com/autarchy-ai/Ground-Control/commit/62294ec499cedccb31632fc5b80a4b39d48c08f4))
* **phase-e:** drop the pickup label when the issue actually closes ([03a16c9](https://github.com/autarchy-ai/Ground-Control/commit/03a16c9b2f85dba292b6edd749fe16f214288e40))
* **phase-e:** merge the duplicate github-rest import ([4ce37c1](https://github.com/autarchy-ai/Ground-Control/commit/4ce37c103ab4661dfbd70628898324acf87dac63))
* **policy:** fail a scan that resolved nothing instead of reporting clean ([6282f56](https://github.com/autarchy-ai/Ground-Control/commit/6282f5612f73b4053e12d893170463b991fc6f6f)), closes [#1355](https://github.com/autarchy-ai/Ground-Control/issues/1355)
* **policy:** keep documentation-coverage surfaces anchored to files that exist ([8b4ca14](https://github.com/autarchy-ai/Ground-Control/commit/8b4ca14bc232da898e045b4045380f08fee9d38a))
* **policy:** require one gate record for workflow guardrail sync ([4af2b40](https://github.com/autarchy-ai/Ground-Control/commit/4af2b4093c953c4d085fffe82339ac1c0f442c25))
* **policy:** validate agentic-workflow CLI git-ref and path inputs ([888fe21](https://github.com/autarchy-ai/Ground-Control/commit/888fe21b0754ee205ab2c32be5869b35ecfcc293))
* **publish:** allow ordinary source modules named credentials ([89458cb](https://github.com/autarchy-ai/Ground-Control/commit/89458cbad385635188bb624b4c94c4bb4c2e2790))
* **publish:** allow ordinary source modules named credentials ([fc6f40b](https://github.com/autarchy-ai/Ground-Control/commit/fc6f40bac6e6ae3ce940604d1933ef2bedd5d29b))
* **publish:** allow ordinary source trees named credentials ([8e22095](https://github.com/autarchy-ai/Ground-Control/commit/8e22095bfef20964d8a35dffc05d30e51a038877))
* **publish:** allow ordinary source trees named credentials ([67db595](https://github.com/autarchy-ai/Ground-Control/commit/67db595deff6998be674570080ffeb90dcba53a5))
* recover an unobserved review station without human authorization ([9185dc6](https://github.com/autarchy-ai/Ground-Control/commit/9185dc6cc25f820d262768d8b43bc0d4527d0f42))
* recover an unobserved review station without human authorization ([4856374](https://github.com/autarchy-ai/Ground-Control/commit/4856374df9b4b8b340d89aa328976240e263f810))
* refresh synchronized PR bodies ([f59ca88](https://github.com/autarchy-ai/Ground-Control/commit/f59ca888887c0e754881c3346ad1b59e4daf3676))
* **release:** preserve release identity in PR titles ([7738d1a](https://github.com/autarchy-ai/Ground-Control/commit/7738d1a297a5054ea17dea1fac5847c6b741a2cc))
* **release:** preserve release identity in PR titles ([e6d76ec](https://github.com/autarchy-ai/Ground-Control/commit/e6d76ec76d2bd665149b34f8de1ef62b6bac8a26))
* remove review publication delivery gate ([1fc47f2](https://github.com/autarchy-ai/Ground-Control/commit/1fc47f2b143bd9a3f3ceda10a3c5de9958f39b3b))
* remove review publication delivery gate ([00b6499](https://github.com/autarchy-ai/Ground-Control/commit/00b6499fd37c2b83f353c4cbda667ed6d5b8456c))
* remove unpublished FAIR reference PDFs that break git clone ([074b441](https://github.com/autarchy-ai/Ground-Control/commit/074b44153f5a75d87b6f29422e520d4b5f79271e))
* remove unpublished FAIR reference PDFs that break git clone ([8e1c251](https://github.com/autarchy-ai/Ground-Control/commit/8e1c251610340b61bec862e5a9f52c659a23c45e))
* replace deprecated Spring matchers ([4bcb436](https://github.com/autarchy-ai/Ground-Control/commit/4bcb43657e9eff033a0fbb44c15358bc539a5b96))
* replace deprecated Spring matchers ([6443137](https://github.com/autarchy-ai/Ground-Control/commit/644313776df9a7ecaf3eeb11eaed4599a72cafa3))
* require staged work before binding the verified sync tree ([cdf53ec](https://github.com/autarchy-ai/Ground-Control/commit/cdf53ec040f5258fc279d38ccea7e433d151bf45))
* resolve review publication quality findings ([fef3d75](https://github.com/autarchy-ai/Ground-Control/commit/fef3d7529c05718510fe4d99681020d3533aa8f9))
* restore CI security scanning (SonarCloud, OSV, Trivy) and patch surfaced CVEs ([#1155](https://github.com/autarchy-ai/Ground-Control/issues/1155)) ([6f3a987](https://github.com/autarchy-ai/Ground-Control/commit/6f3a987925003f8be0f3f87a3ca875da9387854c))
* restore CI security scanning (SonarCloud, OSV, Trivy) and patch the surfaced CVEs ([#1155](https://github.com/autarchy-ai/Ground-Control/issues/1155)) ([e8e246a](https://github.com/autarchy-ai/Ground-Control/commit/e8e246a94b505da48f71910df493a0ab826e3ee2))
* restore the deprecated overload javadoc and the committed contract spec ([f54f7c3](https://github.com/autarchy-ai/Ground-Control/commit/f54f7c3c31267d9983f6a7ae6baeb80ca8c21cda))
* retain bounded diagnostics when a preflight worker is killed ([d21f480](https://github.com/autarchy-ai/Ground-Control/commit/d21f480271987de8e72fab1d73037c8172f27499))
* retain bounded diagnostics when a preflight worker is killed ([cc0e24d](https://github.com/autarchy-ai/Ground-Control/commit/cc0e24df87e777a64d5cb7b653ff188fd60e8cb0))
* review every slice of an over-cap diff instead of a manifest ([b60cfe4](https://github.com/autarchy-ai/Ground-Control/commit/b60cfe4cf7406b34c1a6a23c28b140737a216b29))
* review every slice of an over-cap diff instead of a manifest ([254e731](https://github.com/autarchy-ai/Ground-Control/commit/254e731049187f7ad387ad977a9068f49e009111)), closes [#1414](https://github.com/autarchy-ai/Ground-Control/issues/1414)
* review the feature candidate against its requested base during pending merges ([8abd387](https://github.com/autarchy-ai/Ground-Control/commit/8abd387e0e532f33f1ee091c1683664b7b0a6c8a))
* review the feature candidate against its requested base during pending merges ([04c6b26](https://github.com/autarchy-ai/Ground-Control/commit/04c6b2627e323504545a4b501fb1ff40e5bdc378))
* **review-gate:** bind review, lane, and ci evidence to the delivered head ([2ea7081](https://github.com/autarchy-ai/Ground-Control/commit/2ea7081bd5ef6d2a2e1a5607397bba171e5d32af))
* **review-gate:** bind review, lane, and ci evidence to the delivered head ([330e9a5](https://github.com/autarchy-ai/Ground-Control/commit/330e9a5fca572a62a2259d206429ec72f8ce026b))
* **review-gate:** keep git's racy-clean check in the candidate index and make sync tests hermetic ([4e86f04](https://github.com/autarchy-ai/Ground-Control/commit/4e86f04d7d1eafc353b0416ff7d1fad01463d92f))
* **review-gate:** validate the review handle as the exact path string and clear sonar findings ([8d5ab0e](https://github.com/autarchy-ai/Ground-Control/commit/8d5ab0eadcf927939807f34d5f87dbd4d660c0c8))
* **review:** hoist nested template literals and bind the map callback arity ([f75cc34](https://github.com/autarchy-ai/Ground-Control/commit/f75cc3418a2d9ab18cae01ab154d42558c9c2fda))
* **review:** keep ANTHROPIC_API_KEY when it is the review engine's only auth ([14119e0](https://github.com/autarchy-ai/Ground-Control/commit/14119e0d2127066bada417ba23c0987094d2e7ea))
* **review:** keep ANTHROPIC_API_KEY when it is the review engine's only auth ([c1a2abe](https://github.com/autarchy-ai/Ground-Control/commit/c1a2abeb779e92844c706ff01ceaca265e1acbdf))
* **review:** keep the review engine authenticated across launchers ([#1500](https://github.com/autarchy-ai/Ground-Control/issues/1500)) ([cc1d27d](https://github.com/autarchy-ai/Ground-Control/commit/cc1d27d2307d77515bb1d573c4361a31aedd0b11))
* **review:** render prompt builders as array literals and name the status flag ([01d52a5](https://github.com/autarchy-ai/Ground-Control/commit/01d52a5b2fcfb07a1f878ec7d4b45d859e6c155c))
* **review:** resolve SonarCloud code smells in the review lane ([695f2f1](https://github.com/autarchy-ai/Ground-Control/commit/695f2f171d7025b4e56ec5eaf69f1596663db1bb))
* **review:** separate review scope from repository evidence in pre-push prompts ([a43e1bd](https://github.com/autarchy-ai/Ground-Control/commit/a43e1bdf4123ada486300e517e5cb0bbc2e74177))
* **review:** separate review scope from repository evidence in pre-push prompts ([345b3fe](https://github.com/autarchy-ai/Ground-Control/commit/345b3fe77ebc7b064ccf0d4382d8b578141f52be))
* **review:** simplify cap fallback condition ([ccd8d68](https://github.com/autarchy-ai/Ground-Control/commit/ccd8d68b48ce056ad202ba51abcae025c7702a62))
* **sandbox:** accept only guest-initiated forwarding for the sandbox bridge ([2040805](https://github.com/autarchy-ai/Ground-Control/commit/204080597bbecf9be98b3d6aff7b2315c4543fe4))
* **sandbox:** build the probe IPv6 canary from its numeric address ([ec4e494](https://github.com/autarchy-ai/Ground-Control/commit/ec4e494b8641a1fa4ab354aa767b3b360d7e6c4e))
* **sandbox:** clarify packet validation ([900c0ac](https://github.com/autarchy-ai/Ground-Control/commit/900c0ac50051ad88181bd9409c6a26ef575e48c9))
* **sandbox:** close the review findings in the sandbox boundary ([96ec0d1](https://github.com/autarchy-ai/Ground-Control/commit/96ec0d10c033e28209ab368ab0c38569d56569eb))
* **sandbox:** isolate guest bundle materialization ([1f5cbf9](https://github.com/autarchy-ai/Ground-Control/commit/1f5cbf9604a4527070409f4960e2496bca60fb70))
* **sandbox:** publish an artifact every host can import ([d02441d](https://github.com/autarchy-ai/Ground-Control/commit/d02441dc1d3b5b2733328f682835d94eefb9c976))
* **sandbox:** rebuild image archive entry names from a closed grammar ([69b4b53](https://github.com/autarchy-ai/Ground-Control/commit/69b4b5334261f8c1903c267287867605a11ed8e9))
* **sandbox:** refuse archive entries that escape the image directory ([687dc74](https://github.com/autarchy-ai/Ground-Control/commit/687dc74066f302af1502e529a179a64d0b7c824f))
* **sandbox:** repair private repository guest preparation ([cae35ec](https://github.com/autarchy-ai/Ground-Control/commit/cae35ecfb45dd3ac459b2ff33d75e64e4597d19e))
* **sandbox:** repair private repository guest preparation ([8dcb7e6](https://github.com/autarchy-ai/Ground-Control/commit/8dcb7e64eb290918dd6c7ba9731a76828775878d)), closes [#1676](https://github.com/autarchy-ai/Ground-Control/issues/1676)
* **sandbox:** repair runtime provisioning path ([d9276f4](https://github.com/autarchy-ai/Ground-Control/commit/d9276f40e402d3a54e9cc5fae66f6685250ce47d))
* **sandbox:** repair runtime provisioning path ([0e207e3](https://github.com/autarchy-ai/Ground-Control/commit/0e207e3f1c3861bd6dc6c1e104f574f0c9f66324))
* **sandbox:** resolve remaining Sonar findings ([16bf1ce](https://github.com/autarchy-ai/Ground-Control/commit/16bf1ceee8556b00f844c25e5e5bd9901ecfa050))
* **sandbox:** resolve Sonar quality findings ([93ee754](https://github.com/autarchy-ai/Ground-Control/commit/93ee75442058be805c84ff3628deff9363d24891))
* **sandbox:** validate guest bootstrap paths ([7721302](https://github.com/autarchy-ai/Ground-Control/commit/7721302bffd456f76ae1dd90b0693788c51c993c))
* **sandbox:** write archive entries the copy builds itself ([71a1c18](https://github.com/autarchy-ai/Ground-Control/commit/71a1c1863d5458519c5bc16add11d322c89bf6a2))
* satisfy the vale em-dash rules in the unobserved-station docs ([b9ab642](https://github.com/autarchy-ai/Ground-Control/commit/b9ab642e27b1fe4a233c8a78df1c681b4c85f136))
* **security:** close the secret-filter bypass and the plan_rules path escape ([9ec7631](https://github.com/autarchy-ai/Ground-Control/commit/9ec76312ad9dd0160c461ee0377307224375d327))
* **security:** disarm the whole marker namespace and fail closed on repo resolution ([ac66a1b](https://github.com/autarchy-ai/Ground-Control/commit/ac66a1be57fc678502e98a3aa9a96be12f98048b))
* **security:** patch critical/high cves, enforce trivy gate, accept short requirement uids ([04661c4](https://github.com/autarchy-ai/Ground-Control/commit/04661c4a495b9d10a189e8c51afc102f45e0d71a))
* **security:** patch fixable critical/high cves and enforce the trivy gate ([ee978eb](https://github.com/autarchy-ai/Ground-Control/commit/ee978eba38aab6be38bd714517b7dba3bb3c5a3c))
* **security:** raise soupsieve dependency floor ([d47d4ff](https://github.com/autarchy-ai/Ground-Control/commit/d47d4ffea67ce4f8cd279c5e851aa08657f5b51b))
* **security:** raise soupsieve dependency floor ([02f0608](https://github.com/autarchy-ai/Ground-Control/commit/02f060847feec1513246bfa89775e98529d3914e))
* **security:** raise soupsieve dependency floor ([0d821f8](https://github.com/autarchy-ai/Ground-Control/commit/0d821f82cd3cd86579140c8d13eac9f9bfe0f6e6))
* **security:** require repository permission behind a phase-completion marker ([c389eae](https://github.com/autarchy-ai/Ground-Control/commit/c389eae1a6089c5e7ea80c51f2869e4f0fb4fa85))
* sign implement commits per host config and refuse checkout signing programs ([44aa658](https://github.com/autarchy-ai/Ground-Control/commit/44aa65889d9d6726663c6dd810739837a0624558))
* **sonar:** end a watch whose analysis can never arrive and name the real cause ([64d5a2f](https://github.com/autarchy-ai/Ground-Control/commit/64d5a2f61e1d2bc89890c248154801117e4b5271))
* **sonar:** end a watch whose analysis can never arrive and name the real cause ([1335150](https://github.com/autarchy-ai/Ground-Control/commit/133515073a260d1be0e029999f563692efcaa108))
* **sonar:** reduce complexity in the paths the scope pre-check touches ([701c38f](https://github.com/autarchy-ai/Ground-Control/commit/701c38f4b27bd015cec0183f72f6def2f2d1d33b))
* **sonar:** resolve the host token from declared sources and classify unevaluable gates ([c65cc31](https://github.com/autarchy-ai/Ground-Control/commit/c65cc3132c7b4cc5de57b9374740096c2c4e8efb))
* **sonar:** resolve the host token from declared sources and classify unevaluable gates ([8d9548b](https://github.com/autarchy-ai/Ground-Control/commit/8d9548b620122f01df99cacd59a02d2b6330987c))
* specialize version_mirror Any hints and cover refactored config normalizers ([#1540](https://github.com/autarchy-ai/Ground-Control/issues/1540)) ([cb93405](https://github.com/autarchy-ai/Ground-Control/commit/cb9340526fcfeff2c1dd5831372573167f1b3a6e))
* stop reporting queued_too_long for CI runs waiting between jobs ([0193350](https://github.com/autarchy-ai/Ground-Control/commit/019335012b0de1f70e16d8546e27fb95a6db1b4a))
* **telemetry:** address CI and Sonar findings ([981c1c1](https://github.com/autarchy-ai/Ground-Control/commit/981c1c1f419b1f8a3073152c6475b5ab27e6b518))
* **telemetry:** bind phases to canonical stations ([967b61a](https://github.com/autarchy-ai/Ground-Control/commit/967b61a50a73cfa6410885f698074b22ba4a5ed3))
* **telemetry:** bind phases to canonical stations ([822aec1](https://github.com/autarchy-ai/Ground-Control/commit/822aec1279ae9c70a9827f7606054a7c1d6e3df4))
* **telemetry:** clear the SonarCloud new-issue gate ([d973127](https://github.com/autarchy-ai/Ground-Control/commit/d973127c65c91f27620e19de9e24bd88d50f5d06)), closes [#1355](https://github.com/autarchy-ai/Ground-Control/issues/1355)
* **telemetry:** create the child gate artifact directory ([616a4a3](https://github.com/autarchy-ai/Ground-Control/commit/616a4a30b1409c158f8f9ca6ab52e26805e30edc)), closes [#1355](https://github.com/autarchy-ai/Ground-Control/issues/1355)
* **telemetry:** record the pull request number on live-emitted workflow runs ([650a34b](https://github.com/autarchy-ai/Ground-Control/commit/650a34b823d9f790f8eb36d6535476ce3600eba9))
* **telemetry:** record the pull request number on live-emitted workflow runs ([55b3eb6](https://github.com/autarchy-ai/Ground-Control/commit/55b3eb6bf9037d55655a2fe3896546df0dac2436))
* **telemetry:** report a truncated finding batch instead of dropping it silently ([d69f207](https://github.com/autarchy-ai/Ground-Control/commit/d69f207eaed07b41ba51b94c229739826b427f47)), closes [#1355](https://github.com/autarchy-ai/Ground-Control/issues/1355)
* **telemetry:** resolve SonarCloud new-issue findings ([717e62f](https://github.com/autarchy-ai/Ground-Control/commit/717e62f6b578ab654668aa7d97b7c582826ca00a))
* update publication policy and anyio security floor ([b10b220](https://github.com/autarchy-ai/Ground-Control/commit/b10b220f4793757c167f4905b8b4cc758f17cafe))
* validate Phase E workflow before readiness ([99270b4](https://github.com/autarchy-ai/Ground-Control/commit/99270b4ac4856d61429c8547c18098e531142a49))
* validate Phase E workflow before readiness ([8f25c92](https://github.com/autarchy-ai/Ground-Control/commit/8f25c92c58f0981e6576234f334f891bfa788643))
* **workflow:** enforce worktree and Phase E boundaries ([d986c2a](https://github.com/autarchy-ai/Ground-Control/commit/d986c2a2a46edeef12bf52c1b9f9828ae3fa1c49))
* **workflow:** enforce worktree and Phase E boundaries ([a7a4919](https://github.com/autarchy-ai/Ground-Control/commit/a7a49196f278ef9c241c4e10b9e557bc254fd1fa))


### Performance Improvements

* **monitor:** revalidate remote-gate reads and fail fast on a conflicted pr ([39ef991](https://github.com/autarchy-ai/Ground-Control/commit/39ef9912663c370f923b5e032f5ab8e4d480d8d0))


### Reverts

* remove the dev to main promotion workflow ([eecd639](https://github.com/autarchy-ai/Ground-Control/commit/eecd639f135edb3a11f6a7d187efc92e30bc01ef))
* remove the dev to main promotion workflow ([53d08bc](https://github.com/autarchy-ai/Ground-Control/commit/53d08bcedc6914dca918be5171442700594247ee))

## [1.1.0](https://github.com/autarchy-ai/Ground-Control/compare/v1.0.1...v1.1.0) (2026-07-25)


### Features

* add ACES concept-family crosswalk v1 and referential-integrity policy gate ([51a5b9a](https://github.com/autarchy-ai/Ground-Control/commit/51a5b9afbc04f757a2c167b74e03f4f37c95cba8))
* add ACES concept-family crosswalk v1 and referential-integrity policy gate ([9c9fbe8](https://github.com/autarchy-ai/Ground-Control/commit/9c9fbe8ac826b8fcf30f8ab71b2c4f75f7b02095))
* add contract surface enforcement gates ([3b55112](https://github.com/autarchy-ai/Ground-Control/commit/3b551129ed982591adebc7b948a9b5f4a814c72c))
* add control assurance workspace ([d7a6c94](https://github.com/autarchy-ai/Ground-Control/commit/d7a6c94ec8017a0bd98e24e3a36063dd60943a47))
* add deterministic control identification and mapping engine (GC-GRC-008) ([46837bb](https://github.com/autarchy-ai/Ground-Control/commit/46837bb78ab0e8c5f76caf605dcff4f3cb42e1a6))
* add dev-start plan gate ([687434f](https://github.com/autarchy-ai/Ground-Control/commit/687434f571965fd50b5b8ed388b7a0626318c8c9))
* add dev-start plan gate ([718d551](https://github.com/autarchy-ai/Ground-Control/commit/718d551c6c93f22359d4e4c9e1763e5347b54a0c))
* add evidence collection adapter interface ([9e63548](https://github.com/autarchy-ai/Ground-Control/commit/9e6354826d5b8d68eb4900e916907182de10b514))
* add grc portfolio reporting view ([002ac38](https://github.com/autarchy-ai/Ground-Control/commit/002ac38e1578041e7323a368cf4f26ef3dfb7ffe))
* add MCP write-contract drift gate against backend OpenAPI (GC-O013) ([794cf1d](https://github.com/autarchy-ai/Ground-Control/commit/794cf1d9e5b0873f0716d0e426627c61ae7e1073))
* add ontology binding contracts and drift gate ([6d529a7](https://github.com/autarchy-ai/Ground-Control/commit/6d529a7ed85f7ce42d49820ae49647c3e8016031))
* add research artifact provenance ledger (ADR-069) ([ab94c64](https://github.com/autarchy-ai/Ground-Control/commit/ab94c64a65727df6bb7ad29123f09b0b6509890b))
* add scoped cld mutation gate ([8874c7a](https://github.com/autarchy-ai/Ground-Control/commit/8874c7a1b7f9ab1fc7e37d8493622365aedcca3f))
* add threat-model endpoint to risk-control mapping (GC-H006) ([72a7876](https://github.com/autarchy-ai/Ground-Control/commit/72a78764f1cdf21fc008db5b6a930dd78852083f))
* adopt Release Please for versioning, changelog, and main-to-dev back-merge ([7d6da66](https://github.com/autarchy-ai/Ground-Control/commit/7d6da660b7d0bdb1e828fdcb72bbd0a344dc28c4))
* adopt Release Please for versioning, changelog, and main-to-dev back-merge ([cd0fa8c](https://github.com/autarchy-ai/Ground-Control/commit/cd0fa8c19b5b5f65f2091b3b8fc85644974421fa))
* **api,frontend:** add traceability matrix view (GC-Q003) ([3c6ed6f](https://github.com/autarchy-ai/Ground-Control/commit/3c6ed6f1101bc32fd810258435a3a3ffd396919a))
* **api,frontend:** Traceability Matrix (GC-Q003) ([e860f1a](https://github.com/autarchy-ai/Ground-Control/commit/e860f1a0d0ce28f34aed593ac647e0f777fdf956))
* **api,mcp:** record per-tool MCP usage telemetry server-side ([c38da50](https://github.com/autarchy-ai/Ground-Control/commit/c38da50ee29cb8fcb0abe894091d33b5788869cb))
* **api,mcp:** record per-tool MCP usage telemetry server-side ([2cd540b](https://github.com/autarchy-ai/Ground-Control/commit/2cd540b883018dc710390bf0838a72cf7a474e8b))
* **api,policy:** add TypeScript enum types and enum-contract parity checks for GRC enums ([83a529d](https://github.com/autarchy-ai/Ground-Control/commit/83a529d9c7aebc2075d6401eeae729e745f62ee1))
* **audit:** make the Envers revision the canonical as-of spine ([ed05972](https://github.com/autarchy-ai/Ground-Control/commit/ed05972c322655ce6bbee057fc686c1a94994ab9))
* **audit:** make the Envers revision the canonical as-of spine ([1c4595e](https://github.com/autarchy-ai/Ground-Control/commit/1c4595ebf4723a314dd7e5534b13c8a562a09df2))
* enforce in-loop control implementation with efficacy tests (GC-GRC-011) ([25be8e8](https://github.com/autarchy-ai/Ground-Control/commit/25be8e8bb8d87d0279463f46866cadbb76761a0e))
* **evidence:** scheduled evidence collection campaigns (GC-S005) ([dd12471](https://github.com/autarchy-ai/Ground-Control/commit/dd12471554124c35e738ba3762927d1fa42f5b6d))
* **evidence:** scheduled evidence collection campaigns (GC-S005) ([8009748](https://github.com/autarchy-ai/Ground-Control/commit/800974872d1fb2caabe139e5b13bbef15e01c7b5))
* fair-cam control analytics for GC-I017 ([d028431](https://github.com/autarchy-ai/Ground-Control/commit/d02843154a08bd523d9c0f8ade6a07690839be17))
* **graph:** project requirement traceability ([d81d971](https://github.com/autarchy-ai/Ground-Control/commit/d81d9711103a2272b092b0756558ff3c59bc39a4))
* **graph:** project workflow runs into context graph ([28787df](https://github.com/autarchy-ai/Ground-Control/commit/28787df506697d3e18fe6723d3934494b231db48))
* **graph:** project workflow runs into context graph ([7164263](https://github.com/autarchy-ai/Ground-Control/commit/7164263a3d1d054c2a353312efe980c4f9595836))
* **grc:** data classification lattice (GC-GRC-006) ([24e26a9](https://github.com/autarchy-ai/Ground-Control/commit/24e26a9c19a0b4625e766dc63a6b02d25ac74be6))
* harden operator-driven deploy with drift gate, env validation, rollback, and deploy state ([24cdc0e](https://github.com/autarchy-ai/Ground-Control/commit/24cdc0e9d4cd038f357cc6586bac050a9aa391c6))
* human gates for merge observation and authorized operator signals (GC-O009) ([3f8226d](https://github.com/autarchy-ai/Ground-Control/commit/3f8226de5b47e4f0c7b1767457e6071681541074))
* **implement:** automate over-cap review disposition (gc_review_cap_disposition) ([3da5251](https://github.com/autarchy-ai/Ground-Control/commit/3da5251a2aef9d5de14768eaa894d9ef409bad69))
* **implement:** automate over-cap review disposition (gc_review_cap_disposition) ([cf3d660](https://github.com/autarchy-ai/Ground-Control/commit/cf3d660daa43d80e85fa20648992397e2c60b867)), closes [#1245](https://github.com/autarchy-ai/Ground-Control/issues/1245)
* **mcp:** add gc_assert_grc_reconciled GRC completion gate ([#1100](https://github.com/autarchy-ai/Ground-Control/issues/1100)) ([e0bd382](https://github.com/autarchy-ai/Ground-Control/commit/e0bd3828b7514284cd44077a86d3e1a2d85bffb3))
* **mcp:** add server-side GRC reconciliation gate (gc_assert_grc_reconciled) ([f38c31b](https://github.com/autarchy-ai/Ground-Control/commit/f38c31b4b8766c073efb96eaa1a3687534347b94))
* **mcp:** wire quality-gate evaluation into the /implement completion gate ([#1101](https://github.com/autarchy-ai/Ground-Control/issues/1101)) ([6ff75e6](https://github.com/autarchy-ai/Ground-Control/commit/6ff75e67ab0490c89228d975d4b395d205fb3340))
* **mcp:** wire quality-gate evaluation into the /implement completion gate ([#1101](https://github.com/autarchy-ai/Ground-Control/issues/1101)) ([b60c612](https://github.com/autarchy-ai/Ground-Control/commit/b60c612c9c28288564f499f7d9b9c6c030306916))
* methodology requirements contract artifact (ADR-079) ([ae51df0](https://github.com/autarchy-ai/Ground-Control/commit/ae51df00e905fe189bd9caea87950ded285ed726))
* methodology source-coverage gate with backend method-profile registry ([df7e84f](https://github.com/autarchy-ai/Ground-Control/commit/df7e84ffc685260314fcb3744ee28cca24135703))
* **workflow:** add Step 3.5 GRC screening gate (GC-O012) ([9800cb6](https://github.com/autarchy-ai/Ground-Control/commit/9800cb613a5e5e42af5e7730233784285eab12c0))
* **workflow:** add Step 3.5 GRC screening gate (GC-O012) ([c77e10a](https://github.com/autarchy-ai/Ground-Control/commit/c77e10aa0bb73a3c448563b055ffe5534b61209c))
* **workflow:** explain implement outcome and next issue ([5e1a39f](https://github.com/autarchy-ai/Ground-Control/commit/5e1a39ff829e1a83780e034fc8b0a3ae8ca748a2))
* **workflow:** explain implement outcome and next issue ([7a6f472](https://github.com/autarchy-ai/Ground-Control/commit/7a6f472bd9a824cc650ed78946ac7efaae618666))
* **workflow:** run /implement transition + reconcile post-merge (Phase E) ([9c75d7f](https://github.com/autarchy-ai/Ground-Control/commit/9c75d7fe7e74b45bd919b5932bee44aa148a4ac4))
* **workflow:** run /implement transition + reconcile post-merge (Phase E) ([9e8dad3](https://github.com/autarchy-ai/Ground-Control/commit/9e8dad34a90dad6f3c7094bdae1900df04ce9cfb))


### Bug Fixes

* activate and verify commit-time pre-commit hooks under a global hooks dispatcher ([58508f0](https://github.com/autarchy-ai/Ground-Control/commit/58508f0949a8118dce47caf542ae16ebf017ba2d))
* activate and verify commit-time pre-commit hooks under a global hooks dispatcher ([#1153](https://github.com/autarchy-ai/Ground-Control/issues/1153)) ([ebafd5a](https://github.com/autarchy-ai/Ground-Control/commit/ebafd5ab7506c585bd7ec84a89ce2c03b9f7fc73))
* address documentation gate sonar findings ([81b1819](https://github.com/autarchy-ai/Ground-Control/commit/81b1819cef1c89d9aec46b5d5170c0a453bd6824))
* allow base-to-feature merges in git-merge-guard while blocking protected/PR merges ([b82997a](https://github.com/autarchy-ai/Ground-Control/commit/b82997a9aaa5d8cbc9298333e19f29b2546d04e8))
* allow base-to-feature merges in git-merge-guard, keep protected/PR merges blocked ([#1382](https://github.com/autarchy-ai/Ground-Control/issues/1382)) ([9ac4cd3](https://github.com/autarchy-ai/Ground-Control/commit/9ac4cd3af17bb1cd1da19d3de4ad261ca75e268b))
* **api:** rename McpTelemetryService.record to recordEvent (Sonar S6213) ([bcdc703](https://github.com/autarchy-ai/Ground-Control/commit/bcdc703d7d901ecd4a6a5d514695717cbb2ed208))
* **audit:** resolve sonarcloud quality gate findings ([e4b6c7d](https://github.com/autarchy-ai/Ground-Control/commit/e4b6c7dfb1885288692ba57aa1fc59c4b1034b24))
* **ci:** align SonarCloud analysis for dev ([49253a7](https://github.com/autarchy-ai/Ground-Control/commit/49253a77df5e086d6801e0be7d089c5e6db3f889))
* **ci:** repoint SonarCloud to brad-edwards org project ([0198f08](https://github.com/autarchy-ai/Ground-Control/commit/0198f0826f660d0064a7ff15e5bdec99a6db85d2))
* derive repository identity from the checkout remote ([411424e](https://github.com/autarchy-ai/Ground-Control/commit/411424ece808d1bbdc07056f6e5cc1700d1465b4))
* derive repository identity from the checkout, not stale config/env ([#1383](https://github.com/autarchy-ai/Ground-Control/issues/1383)) ([22a80f7](https://github.com/autarchy-ai/Ground-Control/commit/22a80f7798be92a6ddd60c89f640b95a9351588b))
* downgrade unsatisfiable protected-path approval gate to non-blocking ([#1330](https://github.com/autarchy-ai/Ground-Control/issues/1330)) ([d257769](https://github.com/autarchy-ai/Ground-Control/commit/d257769227fb0ed364a01b3e83d829e6f3675adc))
* enforce documentation coverage for draft requirements ([a64f3b7](https://github.com/autarchy-ai/Ground-Control/commit/a64f3b78a0e69825cd627b7c569a7590f85a0ddb))
* enforce documentation coverage for draft requirements ([db4b629](https://github.com/autarchy-ai/Ground-Control/commit/db4b6291a651dfa2479257021c18d4222731629a))
* **evidence:** resolve SonarCloud quality gate on PR [#1260](https://github.com/autarchy-ai/Ground-Control/issues/1260) ([be13657](https://github.com/autarchy-ai/Ground-Control/commit/be136573edf297e3eb1353c858549932a3e314b1))
* gc_create_github_issue no longer renders undefined title/body ([68b22a9](https://github.com/autarchy-ai/Ground-Control/commit/68b22a93cd42cd3f9630d36e85362dd7e9327601))
* harden implement workflow and dependencies ([1378518](https://github.com/autarchy-ai/Ground-Control/commit/1378518faf891fb01092f85f4b88d3ed5d38fc11))
* map controller @WebMvcTest companion by fully-qualified class, not stem ([8e527da](https://github.com/autarchy-ai/Ground-Control/commit/8e527da204cfdc5a7879090fccd934633f5bb45d))
* **mcp:** document per-action required fields in tool descriptions ([78cf5d2](https://github.com/autarchy-ai/Ground-Control/commit/78cf5d205e370e4c322ac00932673b9a48885097))
* **mcp:** document per-action required fields in tool descriptions ([50a86ce](https://github.com/autarchy-ai/Ground-Control/commit/50a86ce47d088deca65cbbb1cbed780af6680f92))
* **mcp:** reconcile gc_risk_governance create contracts with backend DTOs ([e0ca0e4](https://github.com/autarchy-ai/Ground-Control/commit/e0ca0e485c52a5463ed07f384706fc4b7d3dd4f6))
* **mcp:** reconcile gc_risk_governance create contracts with backend DTOs ([91aad4d](https://github.com/autarchy-ai/Ground-Control/commit/91aad4d2484c701df02fe580b1f84abfac01aeda))
* normalise risk-scenario-workspace 500 on legacy date-only action-item dueDate ([1867cf8](https://github.com/autarchy-ai/Ground-Control/commit/1867cf829264b62e771b5d8b5c2f0204973ac0bc))
* policy PR-comments parser rejects single-comment threads ([#1334](https://github.com/autarchy-ai/Ground-Control/issues/1334)) ([92669d5](https://github.com/autarchy-ai/Ground-Control/commit/92669d5281e842d931167626cca946de141462eb))
* publish AGE graph projection as atomic versioned snapshots ([4af775e](https://github.com/autarchy-ai/Ground-Control/commit/4af775e7ca99cea070a9b1155e37950ff7e6d2fe))
* reject GRC project type at creation ([cab4466](https://github.com/autarchy-ai/Ground-Control/commit/cab4466f92fec147c90452972cee34adf0a3e5f1))
* reject GRC project type at creation (ADR-089 §4) ([4887ea6](https://github.com/autarchy-ai/Ground-Control/commit/4887ea6de007adc89a602ca7e3d8591005769707)), closes [#1385](https://github.com/autarchy-ai/Ground-Control/issues/1385)
* remove retired orchestration config and console assumptions ([37adbcb](https://github.com/autarchy-ai/Ground-Control/commit/37adbcb5aa9fe2ebbd01610f99514a6d5f8f7636))
* resolve SonarCloud findings ([b554a2d](https://github.com/autarchy-ai/Ground-Control/commit/b554a2d79072119aa7196f6dccfcab032236c622))
* route async-poll /implement stages to the parent agent ([97bb58c](https://github.com/autarchy-ai/Ground-Control/commit/97bb58cb8c2d96c10b674eae361dee743ad11e26))
* route async-poll /implement stages to the parent agent ([f48308e](https://github.com/autarchy-ai/Ground-Control/commit/f48308eb3caa2eb345078b79097c65d3ba98f4a6))
* scope policy diff to merge-base so trailing branches aren't over-flagged ([720c978](https://github.com/autarchy-ai/Ground-Control/commit/720c9783a199f62b0e7e6794f7a3b0e6691fc037))
* scope policy diff to merge-base so trailing branches aren't over-flagged ([2b34375](https://github.com/autarchy-ai/Ground-Control/commit/2b3437579a620570c0cd2fc2fae7abf73ddae256))
* **sonar:** resolve new SonarCloud issues on GC-Q003 ([5408b93](https://github.com/autarchy-ai/Ground-Control/commit/5408b93ed43c685f623506c8bec23bf594da1d9a))
* **sonar:** resolve SonarCloud issues blocking the dev-&gt;main gate ([#1085](https://github.com/autarchy-ai/Ground-Control/issues/1085)) ([1914bdf](https://github.com/autarchy-ai/Ground-Control/commit/1914bdfcbdb6849d21b3441a6d548d9013611e2f))
* **sonar:** resolve SonarCloud issues blocking the dev-&gt;main gate ([#1085](https://github.com/autarchy-ai/Ground-Control/issues/1085)) ([d8c6601](https://github.com/autarchy-ai/Ground-Control/commit/d8c6601aad69eca2142029dcc2444d7868c73fa5))
* **sonar:** revert migration edits (immutable), sync ADR-054/DOC_STYLE, add changelog ([#1085](https://github.com/autarchy-ai/Ground-Control/issues/1085)) ([12efec2](https://github.com/autarchy-ai/Ground-Control/commit/12efec241f5018b32896f0df7db6ff15617b4f17))
* standardize GHCR namespace and add deploy staleness guard ([f765ded](https://github.com/autarchy-ai/Ground-Control/commit/f765ded90cf7702b958b3c76706735813e6eb3d8))
* **workflow:** skip umbrella issues in next-issue recommendation ([5353b93](https://github.com/autarchy-ai/Ground-Control/commit/5353b933dc8de7f9bbaae13a0b1fd00ca7e030d4))
* **workflow:** skip umbrella issues in next-issue recommendation ([94d51b0](https://github.com/autarchy-ai/Ground-Control/commit/94d51b0a1d26ab23288f878526f985113d6ca0ae))


### Reverts

* remove compliance-requirement-traceability operating-control record ([#1255](https://github.com/autarchy-ai/Ground-Control/issues/1255)) ([027b751](https://github.com/autarchy-ai/Ground-Control/commit/027b75177b46e7e7890056353ba7ee917c3892ac))
